...
func (r *ReadWrapper[T]) GetFilteredIDs(o *FilteringOpts) (filtered []string, lastID string, err error) {
...
func (r *ReadWrapper[T]) AppendFilteredIDs(in []string, o *FilteringOpts) (filtered []string, lastID string, err error) {
